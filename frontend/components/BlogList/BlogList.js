                            ...
                            {blogs.slice(0,3).map((blog, bitem) => (
                                <div className="news-standard-items" key={bitem}>
                                    ...
                                    <div className="news-content">
                                        ...
                                        <Link onClick={ClickHandler} href={'/blog-single/[slug]'} as={`/blog-single/${blog.slug}`} className="link-btns">Read More <i className="fa-sharp fa-regular fa-arrow-right-long"></i></Link>
                                    </div>
                                </div>
                            ))}
