        ...
        <section className={"" +props.hclass}>
            ...
            <div className="container">
                <div className="section-title-area">
                    ...
                    <Link onClick={ClickHandler} href="/about" className="theme-btn wow fadeInUp" data-wow-delay=".5s">
                        more about us
                    </Link>
                </div>
            </div>
                        ...
                        {Project.slice(4, 12).map((project, item) => (
                            <div className="item" key={item}>
                                <div className="project-image">
                                    <Image src={project.pimg1} alt={project.title} style={{ width: '100%', display: 'block' }} />
                                    <div className="portfolio-content">
                                        <h3>
                                            <Link onClick={ClickHandler} href={'/project-details/[slug]'} as={`/project-details/${project.slug}`}>
                                                {project.title}
                                            </Link>
                                        </h3>
                                        <h4>AI</h4>
