...
import Pimg1 from '/public/images/portfolio/cap.png'
import Pimg2 from '/public/images/portfolio/shape-2.png'
import Pimg3 from '/public/images/portfolio/shape-3.png'
        ...
        <section className="portfolio-section section-padding pt-0">
            <div className="portfolio-wrapper">
                <div className="cap-shape float-bob-x">
                    <Image src={Pimg1} alt="img" />
                </div>
                <div className="shape-2 float-bob-y">
                    <Image src={Pimg2} alt="img" />
                </div>
                <div className="shape-3">
                    <Image src={Pimg3} alt="img" />
                </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-6">
                            <div className="portfolio-content">
                                ...
                                <Link href="/shop" className="theme-btn wow fadeInUp" data-wow-delay=".3s">Custom order</Link>
                            </div>
                        </div>
                        <div className="col-xl-6">
                                    ...
                                    {Portfolio.slice(0, 4).map((portfoli, index) => (
                                        ...
                                        >
                                            <div className="portfolio-image">
                                                <Image src={portfoli.pimg1} alt="img" />
                                                <Link onClick={ClickHandler} href={'/project-details/[slug]'} as={`/project-details/${portfoli.slug}`} className="icon">
                                                    <i className="fa-solid fa-arrow-right"></i>
                                                </Link>
                                                <div className="portfolio-content" style={{ transform: activeImage === index ? `translate(${cursorPos.x}px, ${cursorPos.y}px)` : 'none' }}>
                                                    <h3><Link onClick={ClickHandler} href={'/project-details/[slug]'} as={`/project-details/${portfoli.slug}`} >{portfoli.title}</Link></h3>
