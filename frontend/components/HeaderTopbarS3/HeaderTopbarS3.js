        ...
        <div className="header-top-3">
            <div className="container-fluid">
                <div className="header-top-wrapper style-3">
                    <p><Link onClick={ClickHandler} href="del:+41888567890">(+41)-888-56-7890</Link>  (Mon - Sat 9am to 6pm)</p>
                    ...
                    <div className="header-top-right">
                        <div className="social-icon d-flex align-items-center">
                            ...
                            <Link onClick={ClickHandler} href="#"><i className="fab fa-instagram"></i></Link>
                            <Link onClick={ClickHandler} href="#"><i className="fab fa-pinterest-p"></i></Link>
                        </div>
