    ...
    return (
        <section className="product-section section-padding pt-0">
            <div className="shape-image">
                <Image src={ProdactShape} alt="img" />
            </div>
            <div className="container">
                                        ...
                                        <div className="product-box-items">
                                            <div className="product-image">
                                                ...
                                                <ul className="product-icon d-grid align-items-center">
                                                    ...
                                                    <li>
                                                        <Link onClick={ClickHandler} href={'/shop-details/[slug]'} as={`/shop-details/${product.slug}`}><i className="fa-regular fa-arrow-up-arrow-down"></i></Link>
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="product-content">
                                                ...
                                                <h6><Link onClick={ClickHandler} href={'/shop-details/[slug]'} as={`/shop-details/${product.slug}`}>{product.title}</Link></h6>
                                    ...
                                    <div className="col-xl-3 col-lg-4 col-md-6" key={pitem}>
                                        <div className="product-box-items">
                                            <div className="product-image">
                                                ...
                                                <ul className="product-icon d-grid align-items-center">
                                                    <li>
                                                        <Link onClick={ClickHandler} href={'/shop-details/[slug]'} as={`/shop-details/${product.slug}`}><i className="fa-sharp fa-regular fa-eye"></i></Link>
                                                    </li>
                                                    <li>
                ...
                <div className="shop-button text-center mt-5 " >
                    <Link onClick={ClickHandler} href="/shop" className="theme-btn">View all Product</Link>
                </div>
            </div>
        </section>
    );
