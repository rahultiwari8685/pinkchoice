...
import P3 from '/public/images/project/details-3.jpg'
import P4 from '/public/images/project/details-4.jpg'
...
const ProjectSinglePage = () => {
    ...
    const ProjactDetailPage = Projact.find(item => item.slug === router.query.slug)
                    ...
                    <div className="project-details-wrapper">
                            ...
                            <div className="col-lg-3">
                                <div className="details-info">
                                    ...
                                    <div className="info-items">
                                        <h5>Website</h5>
                                        <Link onClick={ClickHandler} href="#">wiatech.com</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row g-4">
                                <div className="col-lg-4">
                                    <div className="details-image">
                                        <Image src={ProjactDetailPage?.pS1img} alt="img" />
                                    </div>
                                </div>
                                <div className="col-lg-8">
                                    <div className="details-image">
                                        <Image src={ProjactDetailPage?.pS2img} alt="img" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="previous-button">
                            <div className="preview-button">
                                ...
                                <h4>
                                    <Link onClick={ClickHandler} href="#">Business Website Design</Link>
                                </h4>
                            </div>
                            <div className="icon">
                            ...
                            <div className="preview-button style-2">
                                ...
                                <h4>
                                    <Link onClick={ClickHandler} href="#">Mobile Application Design</Link>
                                </h4>
                            </div>
                        </div>
                    </div>
