...
import Video from '/public/images/service/details-2.jpg'
import simg1 from '/public/images/service/details-3.jpg'
import simg2 from '/public/images/service/details-4.jpg'
import simg3 from '/public/images/service/details-5.jpg'
import simg4 from '/public/images/service/details-6.jpg'
                                ...
                                <div className="service-details-content">
                                    ...
                                    <div className="service-image-item">
                                        <div className="row g-4">
                                            ...
                                            <div className="col-lg-5">
                                                <div className="service-box-image">
                                                    <Image src={simg3} alt="img" />
                                                </div>
                                            </div>
                                            <div className="col-lg-7">
                                                <div className="service-box-image">
                                                    <Image src={simg4} alt="img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
