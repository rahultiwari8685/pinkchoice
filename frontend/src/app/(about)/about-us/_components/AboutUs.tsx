    ...
    <div className="page-content bg-light">
            ...
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-7">
                <div className="text-start mb-xl-0 mb-4">
                  <h1>
                    Your Fashion Journey Starts Here Discover Style at
                    Pinkchoice
                  </h1>
      ...
      <section className="about-banner overflow-visible">
        <video autoPlay loop muted id="video-background">
          <source
            src="/assets/images/background/bg-video.mp4"
            type="video/mp4"
          />
        </video>
        <div className="about-info">
          <h3 className="dz-title">
            <Link href="/about-me">why Pinkchoice ?</Link>
          </h3>
          <p className="text mb-0">
            At PinkChoice, we believe every woman deserves access to safe,
      ...
      <section className="get-in-touch">
        ...
        <Link href="/contact-us-1" className="btn btn-light">
          Get In Touch
        </Link>
      </section>
      <section className="content-inner">
