...
"[project]/node_modules/nouislider/distribute/nouislider.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/nouislider-react/dist/nouislider-react.umd.production.min.js [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
!function(t, e) {
    ("TURBOPACK compile-time truthy", 1) ? module.exports = e(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/nouislider/distribute/nouislider.js [app-client] (ecmascript)")) : ("TURBOPACK unreachable", undefined);
}(this, function(t, e) {
    "use strict";
    function n(t) {
    ...
    var y = function(t) {
        ...
        return "number" == typeof t && "number" == typeof e || "string" == typeof t && "string" == typeof e ? t === e : Array.isArray(t) && Array.isArray(e) ? JSON.stringify(t) === JSON.stringify(e) : "object" === a(t) && "object" === a(e) && JSON.stringify(y(t)) === JSON.stringify(y(e));
    }, m = function(t, e) {
        var n = t.start, r = t.step, o = t.disabled, i = t.range;
        return e.step === r && b(e.start, n) && e.disabled === o && b(e.range, i);
    }, v = function(e) {
        var n = l(t.useState(null), 2), u = n[0], a = n[1], p = r.default.createRef();
        t.useEffect({
            "v.useEffect": function() {
                var t = e.instanceRef, n = t && Object.prototype.hasOwnProperty.call(t, "current");
                return t && t instanceof Function && t(p.current), n && (t.current = p.current), ({
                    "v.useEffect": function() {
                        n && (t.current = null);
                    }
                })["v.useEffect"];
        ...
        }, b = e.onUpdate, m = e.onChange, v = e.onSlide, g = e.onStart, O = e.onEnd, S = e.onSet, h = function(t) {
            g && (t.off("start"), t.on("start", g)), v && (t.off("slide"), t.on("slide", v)), b && (t.off("update"), t.on("update", b)), m && (t.off("change"), t.on("change", m)), S && (t.off("set"), t.on("set", S)), O && (t.off("end"), t.on("end", O));
        }, j = function() {
            e.clickablePips && s(p.current.querySelectorAll(".noUi-value")).forEach(function(t) {
                t.style.cursor = "pointer", t.addEventListener("click", d);
            });
        }, A = function() {
            if (!p.current.noUiSlider) {
                var t = o.default.create(p.current, function(t) {
        ...
        t.useEffect({
            "v.useEffect": function() {
                var t = e.disabled, n = p.current;
                return n && (y(t), A()), ({
                    "v.useEffect": function() {
                        u && u.destroy(), n && s(n.querySelectorAll(".noUi-value")).forEach({
                            "v.useEffect": function(t) {
        ...
        var w = e.start, E = e.disabled, P = e.range, N = e.step, U = e.margin, k = e.padding, I = e.limit, R = e.pips, T = e.snap, q = e.animate;
        t.useEffect({
            "v.useEffect": function() {
                u && (!({
                    "v.useEffect": function(t) {
                        p.current.noUiSlider.updateOptions(t);
                    }
                })["v.useEffect"]({
                    range: P,
                    step: N,
        ...
        var D = e.id, J = e.className, x = e.style, C = {};
        return D && (C.id = D), J && (C.className = J), r.default.createElement("div", f({}, C, {
            ref: p,
            style: x
        }));
    };
...
//# sourceMappingURL=node_modules_5315fbea._.js.map