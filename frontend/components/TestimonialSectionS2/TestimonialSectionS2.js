...
import Ts1 from '/public/images/testimonial/client-2.png'
import Ts2 from '/public/images/testimonial/client-3.png'
import Ts3 from '/public/images/testimonial/client-4.png'
import Ts4 from '/public/images/testimonial/client-5.png'
import Ts5 from '/public/images/testimonial/client-6.png'
import Ts6 from '/public/images/testimonial/line-shape.png'
import Ts7 from '/public/images/testimonial/line-shape-2.png'
import Tclient1 from '/public/images/testimonial/client-1.png'
import Tclient2 from '/public/images/testimonial/client-2.png'
import Tclient3 from '/public/images/testimonial/client-3.png'
    ...
    return (
        <section className="testimonial-section-2 section-padding">
            <div className="client-1">
                <Image src={Ts1} alt="img" />
            </div>
            <div className="client-2">
                <Image src={Ts2} alt="img" />
            </div>
            <div className="client-3">
                <Image src={Ts3} alt="img" />
            </div>
            <div className="client-4">
                <Image src={Ts4} alt="img" />
            </div>
            <div className="client-5">
                <Image src={Ts5} alt="img" />
            </div>
            <div className="line-shape">
                <Image src={Ts6} alt="img" />
            </div>
            <div className="line-shape-2">
                <Image src={Ts7} alt="img" />
            </div>
